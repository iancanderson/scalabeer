object IbuCalculator {
  ...
  private def ibusTinseth(averageBoilGravity: Double, batchVolume: Volume, hopAddition: HopAddition): Double = {
  ...
  private def hopUtilizationTinseth(averageBoilGravity: Double, hopAddition: HopAddition): Double = {
    val gravityFactor = 1.65 * Math.pow(0.000125, (averageBoilGravity - 1))
